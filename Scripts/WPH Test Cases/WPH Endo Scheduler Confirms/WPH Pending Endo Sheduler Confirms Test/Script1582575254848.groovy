...
WebUI.click(findTestObject('Page_MedTel/BUTTONS/button_Pending Endo Scheduler0'))
...
WebUI.click(findTestObject('Page_MedTel/DIVs/div_Schedule Confirmed_jss1168'))

WebUI.click(findTestObject('Page_MedTel/DIVs/div_Confirmed'))

WebUI.setText(findTestObject('Page_MedTel/Schedule/input__SCH-RM'), '111')
