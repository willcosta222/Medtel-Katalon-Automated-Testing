...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-MRN'), '6786585')
...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-DOB'), '01/05/1949')
...
WebUI.click(findTestObject('Page_MedTel/Stats - Height and Weight/Height-inches Drop Down Menu/div_9_inches'))

WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__jss951 jss936'), '232')
...
WebUI.setText(findTestObject('Page_MedTel/Procedure/input__PRD-PROD (1)'), 'arthroplasty makopl')

WebUI.click(findTestObject('Page_MedTel/DIVs/div_ARTHROPLASTY MAKOPLASTY KNEE TOTAL'))
...
WebUI.setText(findTestObject('Page_MedTel/Procedure/Hip Laterality/input_Laterality_react-select-11-input'), 'ri')
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__IMP-DESC'), 'triathlon ps k')

WebUI.click(findTestObject('Page_MedTel/DIVs/div_Triathlon PS Knee System - Stryker - Sh_a7df29'))
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__IMP-ANC'), 'verasense')

WebUI.click(findTestObject('Page_MedTel/DIVs/div_VERASENSE (Knee) - OrthoSensor - Herman_d81ad8'))
