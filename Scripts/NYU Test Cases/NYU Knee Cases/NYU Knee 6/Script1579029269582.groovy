...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PD-MRN'), '6786585')
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PD-DOB'), '01/05/1949')
...
WebUI.click(findTestObject('Page_MedTel/Height and Weight/Height-inches Drop Down Menu/div_9_inches'))
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PRD-PROD'), 'arthroplasty makopl')
...
WebUI.setText(findTestObject('Page_MedTel/Hip Laterality/input_Laterality_react-select-11-input'), 'ri')
