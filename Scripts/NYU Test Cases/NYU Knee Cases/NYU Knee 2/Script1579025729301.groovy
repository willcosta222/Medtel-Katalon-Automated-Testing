...
WebUI.setText(findTestObject('Page_MedTel/input__PD-DOB'), '10/01/1964')
...
WebUI.click(findTestObject('Page_MedTel/Height-inches Drop Down Menu/div_1_inches'))

WebUI.setText(findTestObject('Page_MedTel/input__jss951 jss936'), '207')
...
WebUI.setText(findTestObject('Page_MedTel/input__IMP-DESC'), 'journey')

WebUI.click(findTestObject('Object Repository/Page_MedTel/div_JOURNEY II BCS Bi-Cruciate Stabilized K_f2cc9d'))

WebUI.click(findTestObject('Page_MedTel/span_Confirm Implants Added'))

WebUI.setText(findTestObject('Page_MedTel/input__IMP-ANC'), 'navi')

WebUI.click(findTestObject('Object Repository/Page_MedTel/div_NAVIO Surgical System - Smith  Nephew -_9e50fd'))
