...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-DOB'), '12/12/1990')
...
WebUI.click(findTestObject('Page_MedTel/Stats - Height and Weight/Height-Feet Drop Down Menu/div_6_feet'))
