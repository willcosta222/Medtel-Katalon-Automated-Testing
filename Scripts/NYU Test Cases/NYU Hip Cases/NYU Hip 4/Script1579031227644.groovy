...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PD-MRN'), '734672')
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PD-DOB'), '08/03/1949')
...
WebUI.setText(findTestObject('Page_MedTel/Height and Weight/input__Weight'), '0211')
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PRD-PROD'), 'arthroplasty hip')
