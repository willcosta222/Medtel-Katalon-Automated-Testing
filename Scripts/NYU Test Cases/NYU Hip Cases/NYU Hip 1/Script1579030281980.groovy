...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/Demographics/input__PD-DOB'), '11/15/2010')

WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_Gender_jss987'))

WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_F'))

CustomKeywords.'medtel.utilities.utilities.inputHeight'('5', '6')

WebUI.setText(findTestObject('Object Repository/Page_MedTel/Stats - Height and Weight/input__Weight'), '148')

WebUI.click(findTestObject('Object Repository/Page_MedTel/Insurance Types/div_Insurance Type_NYU'))

WebUI.click(findTestObject('Object Repository/Page_MedTel/Insurance Types/div_OTHER'))
...
WebUI.click(findTestObject('Object Repository/Page_MedTel/Primary Surgeon -Surgical Location/NYU Surgical Location/div_NYU Langone Orthopedic Hospital (LOH)'))

WebUI.setText(findTestObject('Object Repository/Page_MedTel/Procedure/input__PRD-PROD (1)'), 'arthroplasty hip total')

WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_ARTHROPLASTY HIP TOTAL'))

WebUI.setText(findTestObject('Object Repository/Page_MedTel/Procedure/input__PRD-CPT'), '27130')

WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_27130 - Arthroplasty acetabular and pro_dd70c6'))

WebUI.click(findTestObject('Object Repository/Page_MedTel/Procedure/Hip Laterality/div_Laterality'))
...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/INPUTS/input__IMP-DESC'), 'r3 acetabular')

WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_R3 Acetabular System (Cup) - Smith  Nep_f96de4'))

WebUI.setText(findTestObject('Object Repository/Page_MedTel/INPUTS/input__IMP-DESC'), 'synergy cementless')

WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_SYNERGY Cementless Stem - Smith  Nephew_24692c'))

WebUI.setText(findTestObject('Object Repository/Page_MedTel/INPUTS/input__IMP-DESC'), 'wagner cone p')

WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_Wagner Cone Prosthesis Hip Stem - Zimme_766898'))
