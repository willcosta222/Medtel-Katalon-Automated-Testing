...
WebUI.click(findTestObject('Page_MedTel/NYU/NYU Primary Surgeons/div_Bendo (Stage-NYU), John'))
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PD-DOB'), '11/15/2010')
...
WebUI.setText(findTestObject('Page_MedTel/Height and Weight/input__Weight'), '148')
