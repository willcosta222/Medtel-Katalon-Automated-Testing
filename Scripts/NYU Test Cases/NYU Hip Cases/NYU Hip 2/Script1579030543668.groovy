...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PD-MRN'), '412341')
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PD-DOB'), '10/02/1954')
...
WebUI.setText(findTestObject('Page_MedTel/Height and Weight/input__Weight'), '198')
...
WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__PRD-PROD'), 'replacement hip')
