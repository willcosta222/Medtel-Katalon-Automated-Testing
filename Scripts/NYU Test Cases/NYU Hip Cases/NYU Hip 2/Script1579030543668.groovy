...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/input__PD-MRN'), '412341')
...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/input__PD-DOB'), '10/02/1954')
...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/input__jss951 jss936'), '198')
...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/input__PRD-PROD'), 'replacement hip')

WebUI.click(findTestObject('Object Repository/Page_MedTel/span_REPLACEMENT'))
...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/input__IMP-DESC'), 'm/l')

WebUI.click(findTestObject('Object Repository/Page_MedTel/div_ML Taper Hip Prosthesis - Zimmer Biomet_585373'))

WebUI.setText(findTestObject('Object Repository/Page_MedTel/input__IMP-DESC'), 'continuum a')

WebUI.click(findTestObject('Object Repository/Page_MedTel/div_Continuum Acetabular System - Zimmer Bi_2e37fa'))

WebUI.click(findTestObject('Object Repository/Page_MedTel/span_Confirm Implants Added'))

WebUI.setText(findTestObject('Object Repository/Page_MedTel/input__IMP-ANC'), 'intellijoint')

WebUI.click(findTestObject('Object Repository/Page_MedTel/div_Intellijoint HIP - Intellijoint Surgica_30fccb'))
