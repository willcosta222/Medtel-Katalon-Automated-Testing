...
WebUI.setText(findTestObject('Page_MedTel/input__PD-MRN'), '988567')
...
WebUI.setText(findTestObject('Page_MedTel/input__PD-DOB'), '03/02/1972')
...
WebUI.setText(findTestObject('Page_MedTel/input__jss951 jss936'), '0155')
...
WebUI.setText(findTestObject('Page_MedTel/input__IMP-DESC'), 'antholog')

WebUI.click(findTestObject('Page_MedTel/div_ANTHOLOGY Hip System (Stem) - Smith  Ne_57c8b8'))

WebUI.click(findTestObject('Page_MedTel/span_Confirm Implants Added'))

WebUI.setText(findTestObject('Page_MedTel/input__IMP-ANC'), 'rad')

WebUI.click(findTestObject('Object Repository/Page_MedTel/div_Radlink GPS Tower - Radlink - Jerika Ba_727985'))
