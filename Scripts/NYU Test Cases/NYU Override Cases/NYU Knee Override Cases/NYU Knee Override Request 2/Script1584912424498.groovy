...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-MRN'), 'KNEE OVERRIDE REQ 2')
...
WebUI.click(findTestObject('Object Repository/Page_MedTel/DIVs/div_27446 - Arthroplasty knee condyle and p_36b54e'))
...
WebUI.setText(findTestObject('Page_MedTel/Schedule/input__SCH-TIME (1)'), '08:30 AM')
...
WebUI.click(findTestObject('Page_MedTel/DIVs/div_Standard Demand Knee (NexGen Hi-Flex Pr_7bd685'))

WebUI.click(findTestObject('Object Repository/Page_MedTel/span-p-li-misc/span_Confirm Implants Added'))

WebUI.setText(findTestObject('Page_MedTel/INPUTS/input__IMP-ANC'), 'mako robotic')
