...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-MRN'), 'KNEE OVERRIDE REQ 3')
...
WebUI.setText(findTestObject('Page_MedTel/Schedule/input__SCH-TIME (1)'), '09:30 AM')
