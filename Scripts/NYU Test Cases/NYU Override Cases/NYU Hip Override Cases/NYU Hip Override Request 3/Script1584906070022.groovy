...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-MRN'), 'HIP OVERRIDE REQ 3')
...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-DOB'), '12/15/1930')
