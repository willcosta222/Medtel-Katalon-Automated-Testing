...
WebUI.setText(findTestObject('Page_MedTel/Demographics/input__PD-MRN'), 'HIP OVERRIDE REQ 1')
...
WebUI.click(findTestObject('Page_MedTel/DIVs/div_Approach_jss1156'))

WebUI.click(findTestObject('Page_MedTel/DIVs/div_Anterior'))
...
WebUI.setText(findTestObject('Page_MedTel/Schedule/input__SCH-TIME (1)'), '07:00 AM')
...
WebUI.click(findTestObject('Page_MedTel/DIVs/div_High Demand Hip (Biolox 40mm Continuum _e3b5be'))
