...
WebUI.setText(findTestObject('Object Repository/Page_MedTel/INPUTS/input_Email_email'), 'william.macaulay@nyumc.org')
...
CustomKeywords.'medtel.utilities.utilities.confirmCaseStatus'(GlobalVariable.CaseNumber, '2', true)
...
WebUI.setText(findTestObject('Page_MedTel/Override/div_Override_reason_for_denial'), 'No')

WebUI.click(findTestObject('Page_MedTel/Override/button_Decline Request'))
