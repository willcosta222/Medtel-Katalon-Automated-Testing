...
WebUI.click(findTestObject('Object Repository/Page_MedTel/BUTTONS/button_Yes'))

WebUI.verifyElementNotClickable(findTestObject('Object Repository/Page_MedTel/BUTTONS/button_Cancel Case'))

WebUI.verifyElementNotClickable(findTestObject('Object Repository/Page_MedTel/BUTTONS/button_Amend Case'))

WebUI.click(findTestObject('Object Repository/Page_MedTel/span-p-li-misc/img_Connect_header-logo'))
