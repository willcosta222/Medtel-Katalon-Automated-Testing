...
WebUI.setText(findTestObject('Page_MedTel/Case Navigation/Comments/input__Comment'), 'MANAGER COMMENT 1')
...
WebUI.setText(findTestObject('Page_MedTel/Case Navigation/Comments/input__Comment'), 'REP COMMENT 1')
